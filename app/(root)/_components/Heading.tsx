    ...
    <div className="max-w-3xl space-y-4">
      ...
      <div className="flex items-center justify-center gap-x-2 pt-4">
        <Button variant="outline" size="lg" asChild>
          <Link href="https://github.com/maheshpaulj/NoteScape-2.0/releases/download/v2.3.3/NoteScape.v2.3.3.Windows.Installer.msi">
        ...
        <Button variant="outline" size="lg" asChild>
          <Link href="https://github.com/maheshpaulj/NoteScape-2.0/releases/download/v2.3.3/NoteScape.v2.3.3.MacOS.Installer.dmg">
